...
import qboot_Bootmoney from 'boot/money'

import qboot_Bootmock from 'boot/mock'
...
async function start () {
  ...
  const bootFiles = [qboot_Bootaxios,qboot_Booti18n,qboot_Bootmoney,qboot_Bootmock,qboot_Bootfilters]
